# Создайте список, содержащий три объекта каждого класса (базовый класс People с атрибутами имя и возраст), 
# производный класс Worker, имеющий атрибуты: должность (post) и зарплата (salary), 
